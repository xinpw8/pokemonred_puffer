...
# logging.info(f'baseline.py -> logging init at INFO level')
...
class BaselineRewardEnv(RedGymEnv):
    def __init__(self, env_config: pufferlib.namespace, reward_config: pufferlib.namespace):
        ...
        # logging.info(f'baseline.py -> self.reward_config init: self.reward_config: {self.reward_config}')
        self.step_count = self.unwrapped.step_count
        self.base_event_flags = 0 # self.get_base_event_flags()
        # logging.info(f'baseline.py -> base_event_flags init: base_event_flags: {self.base_event_flags}')
...
class CutWithObjectRewardsEnv(BaselineRewardEnv):
    ...
    def get_game_state_reward(self):
        ...
        try:
            ...
            print(f'Error in get_game_state_reward: {e}')
            rewards = BaselineRewardEnv.get_game_state_reward(self)
