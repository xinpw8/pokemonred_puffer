...
def pokemon_l(game):
    ...
    for i in range(6):
        poke, lev = game.memory[POKE[i]], game.memory[LEVEL[i]]
...
TREE_POSITIONS_GRID_GLOBAL = [(y // 16, x // 16) for x, y, map_n in TREE_POSITIONS_PIXELS]

PLAY_STATE_PATH = (
    __file__.rstrip("environment.py") + "just_died_mt_moon.state"
)  # "outside_mt_moon_hp.state" # "Bulbasaur.state" # "celadon_city_cut_test.state"
